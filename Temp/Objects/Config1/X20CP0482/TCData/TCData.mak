$(AS_CPU_PATH)/TCData/TCData.imx: \
	...
	@'$(AS_BIN_PATH)/BR.AS.Textsystem.Builder.exe' '' -o '$(AS_CPU_PATH)/TCData/TCData.imx' -c '$(AS_INSTALL_PATH)/AS/TechnologyPackages/TextSystem/n.d/ObjectCatalog/Elements/TextConfig/Template/TC.textconfig' -I '$(AS_SYSTEM_PATH)/D0434 $(AS_INSTALL_PATH)/AS/TechnologyPackages/UnitSystem/n.d'  -P '$(AS_PROJECT_PATH)'
